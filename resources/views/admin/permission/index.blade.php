                            ...
                            <div class="col-xl-6">
                                <div class="form-row">
                                    <div class="col-xl-6 mb-3">
                                        <select class="form-control" data-toggle="select" data-live-search="true"
                                            data-allow-clear="true" name="role"
                                            data-live-search-placeholder="{{ __('Search') }}"
                                    ...
                                    <div class="col-xl-6  mb-3">
                                        <select class="form-control ml-2" data-toggle="select" data-live-search="true"
